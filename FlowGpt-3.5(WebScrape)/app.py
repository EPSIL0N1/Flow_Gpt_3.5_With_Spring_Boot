...
response = requests.get("http://localhost:8080/api/patients")
...
To better assist you, could you please tell me your age and name?

(Please respond with your age, and I'll use that information to provide a more personalized response.)

Patient Record: {patient_record}

This revised template asks only one question initially, which is a general question about the user's age. This will give you a starting point to provide a more personalized response.

Once the user responds with their age, you can use the patient record to provide more tailored information and health tips. You can also use the patient record to ask follow-up questions that are more specific to the user's needs.

For example, if the user is under 25, you might ask a follow-up question like:

"Are you experiencing any irregularities in your menstrual cycle? (e.g. heavy bleeding, light bleeding, irregular periods)"

This follow-up question is more targeted to the user's age group and can help you provide more personalized information and health tips.
...
).partial(patient_record=response)
